...
public class NetWorkLoader {
        ...
        private static NetWorkLoader mInstance;
        /**
        ...
        private NetWorkLoader(int threadCount, Type type) {
        ...
        private void init(int threadCount, Type type) {
            ...
            listeners = new HashMap<String, NetWorkLoader.NetResponseListener>();
            this.type = type;
        ...
        public static NetWorkLoader getInstance() {
            if (mInstance == null) {
                synchronized (NetWorkLoader.class) {
                    if (mInstance == null) {
                        mInstance = new NetWorkLoader(DEFAULT_THREAD_COUNT, Type.LIFO);
                    }
                }
            }
            return mInstance;
         ...
         * @return
         */
        public static NetWorkLoader getInstance(int threadCount, Type type) {
            if (mInstance == null) {
                synchronized (NetWorkLoader.class) {
                    if (mInstance == null) {
                        mInstance = new NetWorkLoader(threadCount, type);
                    }
                }
            }
            return mInstance;
