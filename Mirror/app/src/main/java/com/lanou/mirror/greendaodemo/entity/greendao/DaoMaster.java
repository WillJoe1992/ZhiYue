...
import com.lanou.mirror.activity.LoginActivity;
...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        AllHolderDao.createTable(db, ifNotExists);
        HomePagerDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        AllHolderDao.dropTable(db, ifExists);
        HomePagerDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(AllHolderDao.class);
        registerDaoClass(HomePagerDao.class);
